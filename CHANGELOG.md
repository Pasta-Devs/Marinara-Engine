...
- A selection that is refused no longer changes your decision model. It reported the error but also silently switched to None, which stopped every activation question until somebody noticed.
