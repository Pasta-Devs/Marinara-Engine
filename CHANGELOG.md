...
- Professor Mari now shows her work inside her reply, in the order it happened: what she says, her reasoning, and each step she takes. Her replies no longer hide behind a separate work card, a small sprite plays beside the step she is on, and a finished run stays open with its total time and step count.
