...
- Updates reads the installed release channel without waiting for GitHub, so staging does not appear as Stable before a check or when the check fails (#5912).
