...
- Advanced Memory preparation no longer opens Chat Settings after every Roleplay or `/guided` reply; Settings still opens when preparation needs confirmation or reports an error (#6177).
