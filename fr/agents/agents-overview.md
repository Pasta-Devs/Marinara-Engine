...
Une installation neuve de Marinara Engine ne contient aucun agent optionnel. L'application de base et l'installation Termux restent ainsi plus légères. Le catalogue officiel de la v2.3.0 et des versions suivantes propose 36 packages installables en un clic : 6 Writer Agents, 11 Tracker Agents et 19 Misc Agents, dont Long-Term Memory, Maps, Calls, Inventory Tracker et les six jeux de Conversation. Leur code source, leurs manifestes, les fichiers téléchargeables et le catalogue du dépôt sont publics sur [Pasta-Devs/Marinara-Agents](https://github.com/Pasta-Devs/Marinara-Agents). Pour le détail agent par agent, va voir la [Référence des agents téléchargeables](built-in-agents.md). Pour créer les tiens, lis [Créer des agents personnalisés](custom-agents.md).
