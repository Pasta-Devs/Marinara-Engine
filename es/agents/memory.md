...
- **Maximum constant summary size (tokens)** (tamaño máximo de resúmenes constantes) solo cuenta resúmenes constantes activos en **Chat Summaries** (resúmenes del chat), no mensajes actuales, fragmentos recuperados ni escenas archivadas. Unos resúmenes constantes de 8k bajo un límite de 10k no se consolidan por adjuntar mensajes.
