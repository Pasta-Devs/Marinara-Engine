...
Postać też może zaproponować scenę. Obok jej odpowiedzi pojawia się zaproszenie z przyciskiem **Set up scene** (przygotuj scenę), bez zasłaniania rozmowy. Kliknij go, gdy zechcesz otworzyć **Scene Prompt Setup**, wybierz **Prompt preset**, **POV** i **Tense**, a następnie kliknij **Plan Scene**. **Cancel** zamyka okno bez tworzenia sceny; zaproszenie pozostaje dostępne po anulowaniu i odświeżeniu strony.
