...
| `recalled_scenes` | Resumos de cenas selecionadas sem trecho acompanhante. |
| `recalled_messages` | Resumos de cenas com trechos históricos exatos, falantes e intervalos de origem. |
