...
2. **World.** 장르, 배경, 분위기, 난이도, 콘텐츠 등급과 언어를 설정하세요. **Combat Preference**(전투 방식)에서 **Classic**(메뉴 전투) 또는 **Tactical**(격자 전투)을 선택하세요. Tactical 게임에서는 전장 시드, 크기, 지형 지침도 선택적으로 지정할 수 있습니다.
