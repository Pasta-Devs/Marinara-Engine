...
export const CASCADES: Array<{ parent: FileBackedTable; child: FileBackedTable; parentKey: string; childKey: string }> = [
  ...
  { parent: "chats", child: "relationship_saves", parentKey: "id", childKey: "chatId" },
  ...
  { parent: "relationship_saves", child: "relationship_checkpoints", parentKey: "id", childKey: "relationshipSaveId" },
  ...
  { parent: "characters", child: "relationship_saves", parentKey: "id", childKey: "characterId" },
  ...
  { parent: "personas", child: "relationship_saves", parentKey: "id", childKey: "personaId" },
