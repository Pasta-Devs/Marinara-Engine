          ...
          >
            ...
            {sprite ? (
              <img
                ...
                decoding="async"
                className={cn(
                  "absolute bottom-0 right-0 origin-bottom object-contain object-bottom object-center opacity-95 drop-shadow-[0_10px_18px_rgba(0,0,0,0.48)]",
