...
export const GAME_STORYBOARD_STILL_PROMPT_TEMPLATE = [
  ...
  "Use only characters from the game_context allowed visible characters list, plus newly named NPCs explicitly present in this GM narration. Do not include saved-library characters outside that scope.",
