...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 35 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.35/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.36; this Engine supports 1\.35/,
  );
