...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 41 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.41/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.42; this Engine supports 1\.41/,
  );
