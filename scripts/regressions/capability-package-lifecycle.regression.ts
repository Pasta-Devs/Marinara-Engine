...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 12 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.12/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.13; this Engine supports 1\.12/,
  );
