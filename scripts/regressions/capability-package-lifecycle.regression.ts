...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 34 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.34/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.35; this Engine supports 1\.34/,
  );
