...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 33 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.33/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.34; this Engine supports 1\.33/,
  );
