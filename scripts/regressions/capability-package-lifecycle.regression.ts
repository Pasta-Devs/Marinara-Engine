...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 42 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.42/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.43; this Engine supports 1\.42/,
  );
