...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 20 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.20/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.21; this Engine supports 1\.20/,
  );
