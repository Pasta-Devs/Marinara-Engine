...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 26 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.26/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.27; this Engine supports 1\.26/,
  );
