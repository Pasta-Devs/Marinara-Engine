...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 40 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.40/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.41; this Engine supports 1\.40/,
  );
