...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 37 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.37/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.38; this Engine supports 1\.37/,
  );
