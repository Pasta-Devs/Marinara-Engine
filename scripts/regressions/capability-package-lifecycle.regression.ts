...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 38 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.38/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.39; this Engine supports 1\.38/,
  );
